    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={{ flexGrow:1, minHeight: Dimensions.get('window').height, paddingBottom: 80 }}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity onPress={resetProgress} style={styles.resetButton} activeOpacity={0.7}>
        ...
        <View style={styles.courseHeader}>
          ...
          <View style={styles.progressContainer}>
            <View style={styles.progressBar}>
              <View style={[styles.progressFill, { width: `${(progress / roadmapData.items.length) * 100}%` }]} />
            </View>
            <Text style={styles.progressText}>{progress} of {roadmapData.items.length} lessons completed</Text>
          </View>
                ...
                >
                  <View style={[
                    ...
                    {isCompleted ? (
                      ...
                      <Text style={[styles.chapterNumber, isCurrent && { color: '#4C51BF' }]}>
                        {index + 1}
                      </Text>
                    )}
                  </View>
